...
| FR-009 human-facing commands | done | `#print assumptions`, `#print assumption_tree`, and `#print assumption_json` are implemented and exercised by integration tests. The backward-compatibility policy for command names, CLI flags, and schemas is documented in `docs/compatibility-policy.md`. |
