...
- [ ] Certified path (`LeanAssumptions/Core`, `LeanAssumptions/Policy`) — strictest review
...
- [ ] For certified-path changes: conservative failure modes preserved (`unknown`, never silent optimism); HR-001 prohibitions respected
